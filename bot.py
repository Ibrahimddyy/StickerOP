...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("البوت جاهز للبدء انشاء حزمتين واحدة للصور واخرى للفيديو/GIF لاتضف الملصق بصيغية الصور في الحزمة في صيغة الفيديو/GIF :", reply_markup=main_menu())
