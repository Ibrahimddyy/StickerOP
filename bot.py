...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(" البوت جاهز للبدء انشاء حزمتين واحدة للصور واخرى للفيديو/GIF لاتضف الملصق بصيغية الصور في الحزمة بصيغة الفيديو/GIF والعكس كذلك:", reply_markup=main_menu())
